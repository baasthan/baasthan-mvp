  ...
  return (
    <>
            ...
            <div className="md:hidden py-4 border-t">
              <div className="flex flex-col space-y-0.5 px-2">
                ...
                <Button
                  ...
                  className="flex justify-start text-sm text-muted-foreground hover:text-primary font-medium rounded-md px-3 py-2.5 hover:bg-accent/50"
                >
                  Contact Us
                </Button>
      ...
      <ShareDetails
        ...
        onOpenChange={(open) => setShareDetailsOpen(open)}
      />
    </>
  );
};
