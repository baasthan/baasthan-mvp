...
import { PGFormData, createPGSchema } from "@/constants/PgTypes";
...
import AmenitiesPreferences from "./Amenities-Preferences";
import BasicInfo from "./Basic-Info";
import OccupancyPolicy from "./Occupancy-Policy";
