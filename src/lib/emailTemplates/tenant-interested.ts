export function tenantAcknowledgement() {
  return {
            ...
            <tr>
              <td style="padding: 32px 40px;">
                ...
                <p style="margin: 0 0 16px; font-size: 15px; color: #444;">
                  Thank you for sharing your details with us. We’ve received your request and our team will get
                  in touch with you shortly.
                </p>
                <p style="margin: 0 0 24px; font-size: 15px; color: #444;">
                  In the meantime, feel free to explore our community and discover how other hosts are making the most
                  of their properties.
                </p>
